...
- [x] (2 point) Currently Online can only render the other players' position. Try and figure out a way to render change in direction and whether or not a player is moving or not. 
...
- [x] (1 point) Chat Mechanism. Implement a chat system for the online version.
